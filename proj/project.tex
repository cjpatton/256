...
\begin{figure}
\includegraphics[scale=0.5]{predVsActualCensus.png}
\caption{}
...
\begin{figure}
\includegraphics[scale=0.5]{ageContrib.png}
\caption{}
...
In the logistic regression case, we seek to find most effective variable, when it comes to determining how safe a car is.\\
% Table of Parsimonious Variables
