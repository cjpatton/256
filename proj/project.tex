...
\begin{thebibliography}{99}
    ...
    \bibitem{census} Dataset based on Census of 1994. $p=14 \rightarrow 110, n=32561$ Stored locally in \textbf{census.csv}. Downloaded from \url{https://archive.ics.uci.edu/ml/datasets/Adult} 
	...
	\bibitem{shuttle} Shuttle Data.  $p = 9, n = 58000$. 	Stored locally in \textbf{shuttle\_training.csv} and \textbf{shuttle\_testing.csv}. Downloaded from \url{https://archive.ics.uci.edu/ml/datasets/Statlog+\%28Shuttle\%29}
